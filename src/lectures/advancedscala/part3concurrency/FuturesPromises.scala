...
object FuturesPromises extends App {
  ...
  val aFuture = Future {
    calculateMeaningOfLife // calculates the meaning of line on ANOTHER thread
  ...
  // map, flatMap, filter
  // map: if profile fails, then nameOnTheWall will fail with same exception
  ...
  // if both fail, exception of first future will be retained in result
  ...
  object BankingApp {
    ...
    def purchase(username: String, item: String, merchantName: String, cost: Double): String = {
      ...
      // "seconds" comes from scala.concurrent.duration._
