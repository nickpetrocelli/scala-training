...
object MagnetPattern extends App {
  ...
  trait Actor {
    ...
    // def receive(future: Future[P2PResponse]): Int will not compile, type erasure
    // lots of overloads
  }
  ...
  // "magnetize" (no type parameter, as that would break lifting)
  trait AddMagnet {
    def apply(): Int
  }
  ...
  val receiveFV = receive _ // MessageMagnet[Nothing]
  // receiveFV(new P2PResponse) crashes
